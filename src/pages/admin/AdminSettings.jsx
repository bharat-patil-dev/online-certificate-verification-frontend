...
const AdminSettings = () => {
    ...
    const [notifications, setNotifications] = useState({
        ...
        institutionRejected: true,
        certificateActivity: true,
        securityAlerts: true,
    });
                ...
                <div className="lg:col-span-3">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <p className="mt-2 text-xs text-slate-400">
                                        Your administrator email is used for account communication.
                                    </p>
                    ...
                    {activeTab === "notifications" && (
                        <SettingsCard
                            ...
                            description="Control the notifications you receive as an administrator."
                        >
                            ...
                            <div className="divide-y divide-slate-100">
                                ...
                                <NotificationRow
                                    ...
                                    description="Notify me when a new institution submits a registration request."
                                    checked={
                                        notifications.newInstitution
                                    }
                                    onChange={() =>
                                        setNotifications({
                                            ...notifications,
                                ...
                                <NotificationRow
                                    ...
                                    description="Notify me when an institution is approved."
                                    checked={
                                        notifications.institutionApproved
                                    }
                                    onChange={() =>
                                        setNotifications({
                                            ...notifications,
                                ...
                                <NotificationRow
                                    ...
                                    description="Notify me when an institution is rejected."
                                    checked={
                                        notifications.institutionRejected
                                    }
                                    onChange={() =>
                                        setNotifications({
                                            ...notifications,
                                ...
                                <NotificationRow
                                    ...
                                    description="Receive updates related to certificate issuance and revocation."
                                    checked={
                                        notifications.certificateActivity
                                    }
                                    onChange={() =>
                                        setNotifications({
                                            ...notifications,
                                ...
                                <NotificationRow
                                    ...
                                    description="Receive alerts about important administrator account activity."
                                    checked={
                        ...
                        <div className="bg-white rounded-2xl border border-red-200 shadow-sm">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-slate-500 mt-1">
                                            These actions can affect administrator access.
                                        </p>
                                    </div>
                            ...
                            <div className="p-6 space-y-5">
                                ...
                                <DangerItem
                                    ...
                                    buttonText="Sign Out All Sessions"
                                />

                                <DangerItem
                                    title="Delete administrator account"
                                    description="Deleting an administrator account is an irreversible operation."
    ...
    return (
        <div className="p-5 rounded-xl border border-red-200 bg-red-50">
            ...
            <button
                ...
                onClick={() =>
                    alert(
                        `${buttonText} is not available yet.`
                    )
                }
                className="mt-4 inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-red-600 text-white text-sm font-semibold hover:bg-red-700 transition"
            >
                <Trash2 size={16} />
                {buttonText}
            </button>
